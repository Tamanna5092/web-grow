  ...
  return (
    <div className=' grid grid-cols-1 md:grid-cols-5 gap-8 my-20'>
      <div className='md:col-span-3 flex flex-col px-4 md:px-0'>
        ...
        <p className='lora text-lg text-(--text-color)'>We are a team of passionate developers and designers dedicated to creating amazing web experiences that help businesses grow online. Our goal is to deliver high-quality solutions that are fast, user-friendly, and optimized for success. We focus on building modern, responsive websites and implementing result-driven digital marketing strategies that increase visibility, attract more customers, and boost overall business performance. With a strong commitment to quality, creativity, and innovation, we ensure every project we deliver meets the highest standards and provides real value to our clients. <Link to="/about" className='text-(--primary-color) hover:underline'>More</Link></p>
      </div>
