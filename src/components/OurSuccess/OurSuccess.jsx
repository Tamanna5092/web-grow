        ...
        <div className="w-full">
          <div className="max-w-7xl mx-auto grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 px-4 md:px-0">
            <div className="w-full border-b border-(--primary-color)">
              <h3 className="text-3xl md:text-6xl font-extrabold">28+</h3>
              <p className="lora text-xl text-(--primary-color) mb-2">
                Satisfied Clients
              </p>
            </div>
            <div className="w-full border-b border-(--primary-color)">
              <h3 className="text-3xl md:text-6xl font-extrabold">30+</h3>
              <p className="lora text-xl text-(--primary-color) mb-2">
                Projects Complete
              </p>
            </div>
            ...
            <div className="w-full border-b border-(--primary-color)">
              <h3 className="text-3xl md:text-6xl font-extrabold">4+</h3>
              <p className="lora text-xl text-(--primary-color) mb-2">
                Years of Experience
              </p>
            </div>
